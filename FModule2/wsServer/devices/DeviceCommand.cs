...
namespace wsServer
{
    ...
    {
        public static string 打开红灯命令 = "A5030000000000";
        public static string 关闭红灯命令 = "A5020000000000";
        public static string 打开绿灯命令 = "[10000000000000010300011001]";
        public static string 关闭绿灯命令 = "[10000000000000010300011002]";
        public static string 打开黄灯命令 = "A5070000000000";
        public static string 关闭黄灯命令 = "A5060000000000";
        public static string 打开电机命令 = "A5090000000000";
        public static string 关闭电机命令 = "A5080000000000";
        public static string 打开风扇命令 = "A50B0000000000";
        public static string 关闭风扇命令 = "A50A0000000000";
        public static string 查询绿灯状态 = "[10000000000000010100011000]";
        public static string 组网 = "4D41544348";
    ...
    {
        string cmd = DeviceCommandManager.查询绿灯状态;
        Action<string> callback = null;
        public Action<string> Callback
        {
            set { callback = value; }
